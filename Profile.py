...
class DsuProfileError(Exception):
    ...
    in your own code. It is raised when attempting to deserialize a dsu
...
class Profile:
    ...
    provided by each new user created within your program for a2. Pay
    close attention to the properties and functions in this class as you
    ...
    def add_post(self, post: Post) -> None:
        ...
        the posts list. Posts are stored in a list object in the order
        they are added. So if multiple Posts objects are created, but
        added to the Profile in a different order, it is possible for
        the list to not be sorted by the Post.timestamp property. So
        take caution as to how you implement your add_post code.
        """
